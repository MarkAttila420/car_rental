...
- ⏰ **Határidő**: A feladat kiosztását követő **6-ik munkanap** 23:59:59 (CEST)
...
- ❕**Nem baj, ha nem megy egy-egy feladat!** *Nem várjuk el tőled, hogy azonnal mindent tudj* :-) A hozzáállás a lényeg!
...
- le tudja foglalni az adott autót az adati megadásával. ( ⚠️ Egy autó ugyanabban az időszakban nem foglalható kétszer.)

##### Megvalósítandó feladatok és pontjaik

*Kereső felület*

1. Publikus felületen a főoldalon a felhasználó kiválaszt egy valamilyen *daterange picker*-ből egy ***-tól*** és egy ***-ig*** dátumot. (20 pont)
